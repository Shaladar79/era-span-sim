...
const BELONGING_CLOTH_SHOES_SPEED_BONUS: int = 5
const BELONGING_WOVEN_POUCH_GATHERING_BONUS: int = 1
const BELONGING_WARM_WRAP_SICKNESS_CHANCE_REDUCTION: float = 0.05
const BELONGING_BONE_CHARM_THINKING_BONUS: int = 1
const BELONGING_BONE_CHARM_RITUALS_BONUS: int = 1
