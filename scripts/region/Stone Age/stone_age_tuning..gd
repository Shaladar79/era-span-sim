...
const WILD_ANIMAL_WANDER_INTERVAL_MAX: float = 6.0
const WILD_ANIMAL_DANGEROUS_WANDER_INTERVAL_MIN: float = 3.5
const WILD_ANIMAL_DANGEROUS_WANDER_INTERVAL_MAX: float = 8.0

const WILD_ANIMAL_WANDER_CHANCE: float = 0.70
const WILD_ANIMAL_DANGEROUS_WANDER_CHANCE: float = 0.55
