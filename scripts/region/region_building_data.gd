...
const BUILDING_GATHERERS_HUT: String = StoneAgeBuildingData.BUILDING_GATHERERS_HUT
const BUILDING_BONECARVERS_HUT: String = StoneAgeBuildingData.BUILDING_BONECARVERS_HUT

const BUILDING_HUNTERS_HUT: String = StoneAgeBuildingData.BUILDING_HUNTERS_HUT
const BUILDING_FISHING_HUT: String = StoneAgeBuildingData.BUILDING_FISHING_HUT
const BUILDING_WARLEADER_SHELTER: String = StoneAgeBuildingData.BUILDING_WARLEADER_SHELTER
const BUILDING_WARLEADER_TENT: String = StoneAgeBuildingData.BUILDING_WARLEADER_TENT
...
const BUILDING_SPIRITUAL_LEADER_HUT: String = StoneAgeBuildingData.BUILDING_SPIRITUAL_LEADER_HUT
...
const SPIRITUAL_LEADER_HUT_CAPACITY: int = StoneAgeBuildingData.SPIRITUAL_LEADER_HUT_CAPACITY
...
const WARLEADER_TENT_CAPACITY: int = StoneAgeBuildingData.WARLEADER_TENT_CAPACITY
